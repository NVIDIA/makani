...
class MetricsHandler:
    ...
    def __init__(
        ...
        num_rollout_steps,
        device,
        l1_var_names=["u10m", "t2m", "u500", "z500", "q500", "q50", "sp"],
        rmse_var_names=["u10m", "t2m", "u500", "z500", "q500", "q50", "sp"],
        acc_var_names=["u10m", "t2m", "u500", "z500", "q500", "q50", "sp"],
        crps_var_names=["u10m", "t2m", "u500", "z500", "q500", "q50", "sp"],
        spread_var_names=["u10m", "t2m", "u500", "z500", "q500", "q50", "sp"],
        ssr_var_names=["u10m", "t2m", "u500", "z500", "q500", "q50", "sp"],
        rh_var_names=[],
